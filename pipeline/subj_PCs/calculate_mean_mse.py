...
if __name__ == "__main__":
    csv_path = Path("/home/ohadshee/Desktop/Partial-Information-Decomposition/pipeline/subj_PCs/saved_pcs_nostandardization/eigenvector_max=150/checkpoint.csv")
    max_pcs = 150  # Set the maximum number of principal components
    mean_mse_dict = calculate_mean_mse(csv_path, max_pcs)
    report_top_minimal_mean(mean_mse_dict, top_n=30)