...
def simulate_m7_m8_log_det(
    ...
    for i in range(n_trials):
        ...
        if bias_method <= ['jackknife', 'bootstrap']:
...
if __name__ == "__main__":
    ...
    save_path = "/home/ohadshee/Desktop/Thesis_Ohad_Sheelo/Partial_Information_Decomposition/Idep_Simulations/figures/logdet_sim/bootstrap"
    ...
    plot_heatmap_mean_std(m7_results_list, title="M7_LogDet_Bootstrap_Corrected",save_path=save_path)
    plot_heatmap_mean_std(m8_results_list, title="M8_LogDet_Bootstrap_Corrected",save_path=save_path)
